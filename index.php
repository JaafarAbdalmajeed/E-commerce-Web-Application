					...
					<?php for ($i = 0; $i < count($productsArray); $i++) { ?>
						<div class="col-lg-3 col-md-6">
							<div class="single-product">
								<img class="img-fluid" src="admin-panel/img/<?php echo $productsArray[$i]['image'] ?>"
									alt="">
								<div class="product-details">
									<h6 href=""><a class="hover-text text-warning-hover"
											href="single-product.php?productId=<?php echo $productsArray[$i]['id'] ?>">
											<?php echo $productsArray[$i]['name'] ?>
										</a></h6>
									<div class="price">
										<h6>
											<?php echo $productsArray[$i]['price'] ?>
										</h6>
										<h6 class="l-through">
											<?php echo $productsArray[$i]['price_after_sale'] ?>
										</h6>
									</div>
									<div class="prd-bottom">
										<form action="index.php" method="post">
											...
											<input type="hidden" name="id" value=<?= $productsArray[$i]['id'] ?>>
										</form>
									</div>
								</div>
							</div>
